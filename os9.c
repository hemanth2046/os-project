/* Program 9: Banker's Algorithm for Deadlock Avoidance
   Aim: Implement the Banker's Algorithm to (a) check if the system is
   in a safe state and print a safe sequence, and (b) process a
   resource request from a process using the safety algorithm. */
